...
- **⚡️ Client Context & Optimistic Data Push:** Store type-safe client context (page, sort, filters) per connection on the server, and push `optimisticData` payloads directly to client query caches.
