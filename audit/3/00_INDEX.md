...
- **Docs (8 files + root/pkg READMEs):** `README.md`, `docs/README.md`, `docs/getting-started.md`, `docs/api-reference.md`, `docs/client.md`, `docs/server.md`, `docs/pubsub.md`, `docs/validation.md`, `restale-kit/README.md`, `restale-kit/CHANGELOG.md`
