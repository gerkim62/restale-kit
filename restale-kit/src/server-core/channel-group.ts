 ...
 *
 * Conforming adapters are responsible for routing their own internal failures
 * (like network drops or client connection errors during subscribe/unsubscribe)
 * to the registered `onError` handler.
 */
